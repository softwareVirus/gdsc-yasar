  ...
  try {
    ...
    if (participant) {
      ...
      if (participant && participant.answered === false) {
        ...
        if (bcrypt.compareSync(answer, question.correctAnswer)) {
          score += 600;
        ...
        console.log(answer, updatedGame.participants, question.correctAnswer, bcrypt.compareSync(answer, question.correctAnswer), participant);
