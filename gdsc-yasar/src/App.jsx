          ...
          <Routes>
            ...
            <Route path="user" element={<Outlet />}>
              <Route
                path="join_room"
                element={
                  user.email && !gameState.roomCode ? <JoinRoom /> : <Navigater />
                }
              />
              <Route
                path="game_room"
                element={
                  user.email && gameState.roomCode && gameState.questionTime ? (
                    <GameRoom />
                  ) : (
                    <Navigater />
                  )
            ...
            <Route path="admin" element={<Outlet />}>
              <Route
                path="create_room"
                element={
                  user.email && !gameState.roomCode ? <CreateRoom /> : <Navigater />
                }
              />
              <Route
                path="panel"
